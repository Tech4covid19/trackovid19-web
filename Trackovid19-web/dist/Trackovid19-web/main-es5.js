...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _screens_login_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./screens/login/login.component */
    "./src/app/screens/login/login.component.ts");
    /* harmony import */


    var _screens_change_state_change_state_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./screens/change-state/change-state.component */
    "./src/app/screens/change-state/change-state.component.ts");
    /* harmony import */


    var _screens_onboarding_onboarding_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./screens/onboarding/onboarding.component */
    "./src/app/screens/onboarding/onboarding.component.ts");

    var routes = [{
      path: '',
      component: _screens_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"]
    }, {
      path: 'intro-steps',
      component: _screens_onboarding_onboarding_component__WEBPACK_IMPORTED_MODULE_4__["OnboardingComponent"]
    }, // {
    //   path: '',
    //   // auth guard
    //   children: [
    ...
    {
      path: 'change-state',
      component: _screens_change_state_change_state_component__WEBPACK_IMPORTED_MODULE_3__["ChangeStateComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _screens_onboarding_onboarding_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
  ...
  function srcAppScreensChangeStateChangeStateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ChangeStateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 10,
      consts: [[1, "profile_status_container"], ["fxFlex", "49"], ["fxFlexOffset", "2", "fxFlex", "49"], [3, "state", "label"]],
  ...
  function srcAppScreensLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 0,
      consts: [["fxLayout", "row", "fxLayoutAlign", "center", 1, "h-100"], ["fxFlex", "33", 1, "h-100"], ["fxLayout", "column", 1, "wrapper"], [1, "header"], ["src", "assets/img/dgs.png"], [1, "logo"], [1, "login_btn", "button-elevation", "cursor-pointer", 3, "click"], [1, "fb"], ["src", "assets/img/facebook.svg"], [1, "login_text"], [1, "text-grey", "text-center"]],
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_div_click_6_listener() {
  ...
  function srcAppStateUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_datorama_akita_ng_en) {
      ...
      function UsersService(store) {
        ...
        _this2 = _possibleConstructorReturn(this, _getPrototypeOf(UsersService).call(this, store));
        _this2.store = store;
        return _this2;
      }
      ...
      _createClass(UsersService, [{
        ...
        value: function updateUserLocation(geolocation) {
          ...
          return this.getHttp().post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + 'user', geolocation).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (userData) {
            return _this3.store.updateActive(userData);
          }));
        }
      }]);
